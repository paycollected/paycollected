        ...
        <Stack spacing="6">
          ...
          <Box w="75%">
            ...
            >
              ...
              >
                <FormLabel htmlFor="planName" textStyle="formLabel" fontWeight={600}>Plan Name</FormLabel>
                <Input
                  name="planName"
                  type="text"
                  autoFocus
              ...
              >
                <FormLabel htmlFor="perCycleCost" textStyle="formLabel" fontWeight={600}>Per Cycle Cost</FormLabel>
                <InputGroup>
              ...
              >
                <FormLabel htmlFor="billingFrequency" textStyle="formLabel" fontWeight={600}>Billing Frequency</FormLabel>
                <Select
                  variant="outline"
              ...
              <FormControl
                isRequired
              >
                <FormLabel textStyle="formLabel" fontWeight={600}>Start Date</FormLabel>
                <Input
                  type="date"
                  value={startDate}
                  min={fullDate}
